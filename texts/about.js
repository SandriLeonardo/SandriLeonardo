...
export const aboutData = {
  ...
  bio: [
    ...
    "The breadth of my background feeds my engineering mindset. I have been genuinely fascinated by space since long before I chose a degree — not just as a technical frontier, but as a domain that raises questions about scale, time, and physical law. A deep interest in sustainable agriculture and in what it means to deploy autonomous machines in service of environmental goals is not separate from my aims: it is part of why a work feels worth doing. Outside engineering, I read widely — history, philosophy, biology — write, draw, and find animation compelling for the same reason I find robotics compelling: both are attempts to construct believable, purposeful motion from first principles.",
  ],
